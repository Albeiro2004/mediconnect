...
<main class="mc-main" id="main-content">
    ...
    <header class="mc-topbar">
        ...
        <h6 class="mb-0">Mi disponibilidad</h6>
        <button class="btn btn-sm btn-mc text-white" id="btn-nuevo-bloque">
...
<!-- IDs críticos preservados: #modal-bloque, #modal-bloque-titulo, #modal-alert, #bloque-* -->
<div class="modal fade" id="modal-bloque" tabindex="-1" aria-labelledby="modal-bloque-titulo" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title" id="modal-bloque-titulo">Nuevo bloque</h6>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="bloque-dia" class="form-label small">Día de la semana</label>
                    <select class="form-select" id="bloque-dia" required>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <label for="bloque-inicio" class="form-label small">Hora inicio</label>
                        <input type="time" class="form-control" id="bloque-inicio" required>
                    </div>
                    <div class="col-6">
                        <label for="bloque-fin" class="form-label small">Hora fin</label>
                        <input type="time" class="form-control" id="bloque-fin" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 pt-0">
                ...
                <button class="btn btn-sm btn-mc text-white" id="btn-guardar-bloque">
        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title text-danger" id="modal-eliminar-label">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i> ¿Eliminar bloque?
                </h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
