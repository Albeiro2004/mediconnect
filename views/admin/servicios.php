...
<aside class="mc-sidebar" id="sidebar" aria-label="Menú principal">
    ...
    <nav class="mc-sidebar-nav">
        ...
        <a href="<?= htmlspecialchars($w) ?>/views/admin/servicios.php" class="mc-nav-link active">
...
<main class="mc-main" id="main-content">
    ...
    <header class="mc-topbar">
        ...
        <button class="btn btn-sm btn-mc text-white" id="btn-nuevo-servicio">
...
<!-- Modal: Create / Edit Servicio -->
<div class="modal fade" id="modal-servicio" tabindex="-1" aria-labelledby="modal-servicio-titulo" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title" id="modal-servicio-titulo">Nuevo servicio</h6>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="servicio-nombre" class="form-label small">Nombre del servicio</label>
                    <input type="text" class="form-control" id="servicio-nombre"
                           placeholder="Ej: Consulta General" required>
                </div>

                <div class="mb-3">
                    <label for="servicio-descripcion" class="form-label small">Descripción <span class="text-muted">(opcional)</span></label>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <label for="servicio-precio" class="form-label small">Precio (COP)</label>
                        <input type="number" class="form-control" id="servicio-precio"
                               min="0" step="100" placeholder="Ej: 50000">
                    </div>
                    <div class="col-6">
                        <label for="servicio-duracion" class="form-label small">Duración (min)</label>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button class="btn btn-sm btn-mc text-white" id="btn-guardar-servicio">
        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title text-danger" id="modal-eliminar-label">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i> ¿Eliminar servicio?
                </h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
