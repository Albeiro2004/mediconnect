...
<aside class="mc-sidebar" id="sidebar" aria-label="Menú principal">
    ...
    <nav class="mc-sidebar-nav">
        ...
        <a href="<?= htmlspecialchars($w) ?>/views/admin/sedes.php" class="mc-nav-link active">
...
<main class="mc-main" id="main-content">
    ...
    <header class="mc-topbar">
        ...
        <button class="btn btn-sm btn-mc text-white" id="btn-nueva-sede" data-bs-toggle="modal"
                data-bs-target="#modal-sede">
...
<div class="modal fade" id="modal-sede" tabindex="-1" aria-labelledby="modal-sede-titulo" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title" id="modal-sede-titulo">Nueva sede</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <!-- Alerta: sencilla para que funcione con .textContent del JS -->
                <div id="modal-alert" class="alert alert-danger py-2 small d-none"></div>

                <input type="hidden" id="sede-id">

                <div class="mb-3">
                    <label for="sede-nombre" class="form-label small">Nombre</label>
                    <input type="text" class="form-control" id="sede-nombre" placeholder="Ej: Clínica Norte" required>
                </div>

                <div class="mb-3">
                    <label for="sede-ciudad" class="form-label small">Ciudad</label>
                    <input type="text" class="form-control" id="sede-ciudad" placeholder="Ej: Montería" required>
                </div>

                <div class="mb-3">
                    <label for="sede-direccion" class="form-label small">Dirección</label>
                    <input type="text" class="form-control" id="sede-direccion" placeholder="Ej: Cra 5 #10-20" required>
                </div>

                <div class="mb-3">
                    <label for="sede-telefono" class="form-label small">Teléfono <span class="text-muted">(opcional)</span></label>
                    <input type="text" class="form-control" id="sede-telefono" placeholder="Ej: 3001234567">
                </div>

                <div class="mb-1 d-none" id="campo-estado">
                    <label for="sede-estado" class="form-label small">Estado</label>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button class="btn btn-sm btn-mc text-white" id="btn-guardar-sede">
        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title text-danger" id="modal-eliminar-label">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i> ¿Eliminar sede?
                </h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
