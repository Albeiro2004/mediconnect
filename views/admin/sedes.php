...
<div class="mc-sidebar" id="sidebar">
    ...
    <nav class="mc-sidebar-nav">
        ...
        <a href="/mediconnect/views/admin/sedes.php"     class="mc-nav-link active">🏥 <span>Sedes</span></a>
        <a href="/mediconnect/views/admin/medicos.php"   class="mc-nav-link">👨‍⚕️ <span>Médicos</span></a>
...
<script src="/mediconnect/assets/js/admin-sedes.js"></script>
</body>
</html>