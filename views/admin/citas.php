...
<head>
    ...
    <style>
        ...
        .mc-sidebar-brand .fw-bold {
            font-family: 'Instrument Serif', serif; /* Solo marca */
            font-size: 1.4rem;
        }
        ...
        .btn-filter[data-filter="pendiente"].active { background: #ffc107; color: #000; border-color: #ffc107; }
        .btn-filter[data-filter="confirmada"].active { background: #198754; color: #fff; border-color: #198754; }
        .btn-filter[data-filter="finalizada"].active { background: #6c757d; color: #fff; border-color: #6c757d; }
        .btn-filter[data-filter="cancelada"].active { background: #dc3545; color: #fff; border-color: #dc3545; }
        ...
        .btn-action.edit { background: rgba(13,110,253,0.1); color: #0d6efd; border: 1px solid rgba(13,110,253,0.2); }
        .btn-action.edit:hover { background: #0d6efd; color: #fff; }
        .btn-action.delete { background: rgba(220,53,69,0.1); color: #dc3545; border: 1px solid rgba(220,53,69,0.2); }
...
<aside class="mc-sidebar" id="sidebar" aria-label="Menú principal">
    ...
    <nav class="mc-sidebar-nav">
        ...
        <a href="<?= htmlspecialchars($w) ?>/views/admin/citas.php" class="mc-nav-link active">
...
<main class="mc-main" id="main-content">
    ...
    <div class="p-4">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
            <button class="btn btn-sm btn-outline-secondary btn-filter active" data-filter="">
                <i class="bi bi-grid-3x3"></i> Todas
            </button>
            <button class="btn btn-sm btn-outline-warning btn-filter" data-filter="pendiente">
                <i class="bi bi-hourglass-split"></i> Pendientes
            </button>
            <button class="btn btn-sm btn-outline-success btn-filter" data-filter="confirmada">
                <i class="bi bi-check-circle"></i> Confirmadas
            </button>
            <button class="btn btn-sm btn-outline-secondary btn-filter" data-filter="finalizada">
                <i class="bi bi-check2-all"></i> Finalizadas
            </button>
            <button class="btn btn-sm btn-outline-danger btn-filter" data-filter="cancelada">
...
<script src="<?= htmlspecialchars($w) ?>/assets/js/admin-citas.js"></script>
</body>
</html>